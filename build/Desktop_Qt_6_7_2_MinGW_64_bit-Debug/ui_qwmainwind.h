...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/images/account-circle-line.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
#if QT_CONFIG(tooltip)
        actAbout->setToolTip(QCoreApplication::translate("QWMainWind", "\346\211\223\345\274\200\344\270\252\344\272\272\344\277\241\346\201\257", nullptr));
#endif // QT_CONFIG(tooltip)
